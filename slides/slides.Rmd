...
* Once the auditor has the model of $P(X)$ and $P(Y|X)$, and given a set of claimed values $(y_1,y_2,...,y_n)$ ($X$ is not observable to the auditor), he or she can use $(y_1,y_2,...,y_n)$ along with $P(X|Y)$ to update the opinion about true values $X$ and then make inference on the error.
...
\begin{figure}
  \centering
  \includegraphics[scale = 0.4]{table_screenshot.png}
  \\
\end{figure}
